...
export function resolveThemeConfigField({ $themeLocaleConfig, $site }, fieldKey, isArrayField = false, isPlainObject = true) {
  const first = $themeLocaleConfig[fieldKey];
  const second = $site.themeConfig[fieldKey];
  if(isArrayField) {
